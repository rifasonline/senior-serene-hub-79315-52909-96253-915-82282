    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl gradient-hero p-12 md:p-16 lg:p-20 shadow-elegant hover-glow animate-scale-in">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-foreground/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
            ...
            <div className="flex justify-center">
              <Button 
                ...
                className="bg-white/10 text-white hover:bg-white/20 border-2 border-white/30 hover:border-white shadow-card group backdrop-blur-sm"
              >
